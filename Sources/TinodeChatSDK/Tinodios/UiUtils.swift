...
//    public static func routeToBBMessageVC(with view: UIViewController,forTopic topicId: String, completion: ((BBMessageViewController?) -> (Void))? = nil) {
//
//        DispatchQueue.main.async {
//            Cache.log.info("Routing to BBMessageVC for topic=%@", topicId)
...
//
//            let navigationController = UINavigationController(rootViewController: messageVC)
...
extension UIImage {
    ...
    public func pixelData(forMimeType mime: String?) -> Data? {
        return mime == "image/png" ? pngData() : jpegData(compressionQuality: 0.5)
    }
