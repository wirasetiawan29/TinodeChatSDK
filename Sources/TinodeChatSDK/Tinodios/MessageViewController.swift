...
class MessageViewController: UIViewController {
    ...
    private enum Constants {
        ...
        static let kOutgoingBubbleColorLight = UIColor.white
        static let kOutgoingBubbleColorDark = UIColor.white
        static let kOutgoingBubbleColorBlue = UIColor(hex: "#005EB8")
        ...
        static let kIncomingBubbleColorLight = UIColor.white
        static let kIncomingBubbleColorDark = UIColor.white
        ...
        static let kOutgoingMessageContentInset = UIEdgeInsets(top: 4, left: 14, bottom: 15, right: 18)
    ...
    override func loadView() {
        ...
        NSLayoutConstraint.activate([
            ...
            backgroundImageView.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.bottomAnchor),
    ...
    private func setInterfaceColors() {
        view.backgroundColor = UIColor(hex: "#F2F6FB")
    }

    @objc func navBarCallTapped(sender: UIMenuController) {
        let callViewController = CallViewController()
        callViewController.callDirection = .outgoing
        callViewController.isAudioOnlyCall = true
        callViewController.topic = self.topic
...
extension MessageViewController: MessageDisplayLogic {
    ...
    private func leftTitle(_ text: String) -> UILabel {
        let navigationBarSize = navigationController?.navigationBar.bounds
        let leftLabel = UILabel(frame: CGRect(x: 0, y: 0, width: navigationBarSize?.width ?? 0 - 20, height: navigationBarSize?.height ?? 0))
        leftLabel.text = text
        leftLabel.textColor = UIColor.black
        leftLabel.font = .boldSystemFont(ofSize: 17)
    ...
    func updateTitleBar(pub: TheCard?, online: Bool?, deleted: Bool) {
        ...
        let title = pub?.fn ?? NSLocalizedString("Undefined", comment: "Undefined chat name")

        navigationItem.titleView = leftTitle(title)
...
extension MessageViewController: UICollectionViewDataSource {
    ...
    private func configureCell(cell: MessageCell, with message: Message, at indexPath: IndexPath) {
        ...
        if message.isDeleted {
            ...
            //sender
            cell.containerView.backgroundColor = Constants.kOutgoingBubbleColorBlue
        ...
        let textColor = isFromCurrentSender(message: message) ? UIColor.white : UIColor.black
        ...
        if let attributedText = storedMessage.cachedContent {
            ...
            cell.content.textColor = textColor
        }
        ...
        cell.editedMarker.textColor = textColor
